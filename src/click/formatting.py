...
def wrap_text(
    ...
    :param break_on_hyphens: if this flag is set then the wrapping will
                             allow a line break after a hyphen.  Set this
                             to ``False`` when wrapping things like option
                             names, where a break would split the token.
